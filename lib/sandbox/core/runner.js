...
runner.globals.Foo = function Foo() {};
runner.globals.Foo.make = function () {return "MADE"}
runner.globals.Foo.prototype.log = runner.globals.print;
...
function run() {
  ...
  try {
    ...
    runner.emit( 'err', e )
    return process.send( { type: 'result', error: errorAsObject( e ) } )
  }
